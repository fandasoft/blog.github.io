...
import { Container, Header, Title, Content, Footer, FooterTab, Button, Left, Right, Body, Icon, ListItem, Switch } from 'native-base';
import { AppRegistry, StyleSheet, PixelRatio, Text, Navigator, Image, ListView, ScrollView, View, Alert, TouchableHighlight } from 'react-native';
    ...
    render() {
        return (
            <Container>
                    ...
                    <View style={styles.container}>
                        <View style={[styles.item,styles.center]}>
                            <View style={styles.imgview }>
                                <Image style={styles.img} resizeMode="contain" source={{uri:'http://m.tiebaimg.com/timg?wapp&quality=80&size=b150_150&subsize=20480&cut_x=0&cut_w=0&cut_y=0&cut_h=0&sec=1369815402&srctrace&di=638e11be4aa18febd9524a8bf281b0d6&wh_rate=null&src=http%3A%2F%2Fimgsrc.baidu.com%2Fforum%2Fpic%2Fitem%2F94cad1c8a786c917cb87664ccf3d70cf3bc7573a.jpg'}}/>
                                <View style={styles.flex}>
                ...
                <Footer>
                    <FooterTab>
                        <Button onPress={()=>this.onFunction()}>
                            <Icon name="apps" />
                            <Text style={styles.anatomy}>消息</Text>
                        </Button>
                        <Button>
                            <Icon name="camera" />
                            <Text style={styles.anatomy}>工作</Text>
                        </Button>
                        <Button active>
                            <Icon active name="navigate" />
                            <Text style={styles.anatomy}>联系人</Text>
                        </Button>
                        <Button>
                            <Icon name="person" />
                            <Text style={styles.anatomy}>我的</Text>
                        </Button>
                    </FooterTab>
                </Footer>
            </Container>
