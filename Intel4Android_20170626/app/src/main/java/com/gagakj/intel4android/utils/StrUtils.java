...
public class StrUtils {
	...
	public static String getIpCountry() {
		...
		try {
			TelephonyManager mTelephonyManager = (TelephonyManager) IntelApplication
	...
	public static String getIpBaseStation() {
		TelephonyManager telMgr = (TelephonyManager) IntelApplication
				.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
		int cid = 0;
		int lac = 0;
		try {
	...
	public static String getAndroidId() {
		...
		return Secure.getString(IntelApplication.getInstance()
	...
	public static int getIpAddress() {
		int ipAddress = 0;
		WifiManager wifiManager = (WifiManager) IntelApplication.getInstance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
