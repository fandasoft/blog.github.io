...
public class ApprovalHistoryFragment extends BaseFragment implements ResultSubscriber.OnResultListener{
    ...
    public static ApprovalHistoryFragment newInstance(PendingMattersResponse.ResultsBean pendingMattersModel){
    ...
    private void renderTaskOp(List<TaskOpinionsResponse.ResultsBean> taskOpinions){
         commonAdapter = new CommonAdapter<TaskOpinionsResponse.ResultsBean>(getActivity(),taskOpinions,R.layout.item_taskbox_list) {
             @Override
             public void convert(ViewHolder holder, TaskOpinionsResponse.ResultsBean item) {
                 ...
                 holder.setText(R.id.tv_taskbox_name,item.getTaskName())
                         .setText(R.id.tv_worker_name,item.getStatus())
                         .setText(R.id.tv_time, item.getExeFullname());
             }
         };
