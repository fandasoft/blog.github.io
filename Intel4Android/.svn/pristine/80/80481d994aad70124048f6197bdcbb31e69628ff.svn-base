...
public interface INetInterface {
     ...
     * @return
     */
    @GET("mobile/bpm/bpmMobileTask/recTodoListGc.do")
     ...
     * @return
     */
    @GET("mobile/bpm/bpmMobileTask/alreadyMattersGc.do")
     ...
     * @return
     */
    @GET("mobile/bpm/bpmMobileTask/refuseTodoTask.do")
    Observable<RefuseToTaskResponse> refuseTodoTask(@QueryMap HashMap<String, String> params);
     ...
     * @return
     */
    @GET("zhys/epon/mobile/getOltGcInfoList.do")
    Observable<OLTGcInfoListResponse> getOltGcInfoList(@QueryMap HashMap<String, String> params);
     ...
     * @return
     */
    @GET("zhys/epon/mobile/recycleRecource.do")
    Observable<RecycleRecourceResponse> recycleRecource(@QueryMap HashMap<String, String> params);
     ...
     * @return
     */
    @GET("zhys/epon/mobile/oltTest.do")
    Observable<OLTTestResponse> oltTest(@QueryMap HashMap<String, String> params);
}
