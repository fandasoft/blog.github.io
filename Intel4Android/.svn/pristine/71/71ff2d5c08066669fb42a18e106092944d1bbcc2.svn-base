...
public class HTTPHelper {
     ...
     * @param <T>
     */
    public <T extends IModel> void refuseTodoTaskReq(Class<T> clazz, HashMap<String, String> params, int resultType, ResultSubscriber.OnResultListener listener) {
        Observable<T> observable = (Observable<T>) mNetService.refuseTodoTask(params);
        initObservable(observable, resultType, listener);
    }
     ...
     * @param <T>
     */
    public <T extends IModel> void getOltGcInfoListReq(Class<T> clazz, HashMap<String, String> params, int resultType, ResultSubscriber.OnResultListener listener) {
        Observable<T> observable = (Observable<T>) mNetService.getOltGcInfoList(params);
        initObservable(observable, resultType, listener);
    }
     ...
     * @param <T>
     */
    public <T extends IModel> void recycleRecourceReq(Class<T> clazz, HashMap<String, String> params, int resultType, ResultSubscriber.OnResultListener listener) {
        Observable<T> observable = (Observable<T>) mNetService.recycleRecource(params);
        initObservable(observable, resultType, listener);
    }
     ...
     * @param <T>
     */
    public <T extends IModel> void oltTestReq(Class<T> clazz, HashMap<String, String> params, int resultType, ResultSubscriber.OnResultListener listener) {
        Observable<T> observable = (Observable<T>) mNetService.oltTest(params);
        initObservable(observable, resultType, listener);
    }
}
