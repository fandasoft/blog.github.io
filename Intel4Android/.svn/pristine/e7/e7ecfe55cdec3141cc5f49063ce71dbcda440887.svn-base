...
public  class RequestAction {
    ...
    //取消任务
    public static final int ACTION_REFUSE_TODO_TASK = 111;

    //获取挂测列表
    public static final int ACTION_GET_OLTGCLIST = 112;

    //返回挂测信息
    public static final int ACTION_RECYCLE_RECOURCE = 113;

    //一键挂测
    public static final int ACTION_OLT_TEST = 114;
