...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"MacProject"];
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit MacProject" action:@selector(terminate:) keyEquivalent:@"q"];
